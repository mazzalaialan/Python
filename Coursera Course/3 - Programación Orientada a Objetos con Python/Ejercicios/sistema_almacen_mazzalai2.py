...
class CajaRegistradora():
    ...
    def calcular_subtotal(self, descuento):
        ...
        print("El subtotal de la compra es: " + str(round(sumaTotal,2)))
        return sumaTotal
    ...
    def calcular_total(self, descuento):
        ...
        print("El total de la compra es: " + str(round(total,2)))
        return total
    ...
    def Pagar(self, compraTotal, pago):
        ...
        if compraTotal > pago:
            ...
            print("Tu cambio es de: " + str(round(cambio,2)))
            return True, cambio
...
class AlmacenTestCase(unittest.TestCase):
    def setUp(self):
        listaProductos = [Producto("Manzana", 10.00, 10),
        ...
        listaprecios.actualizar_lista(listaProductos)
        self.cajaRegistradora = Compra(listaProductos)
